            ...
            db.teclado.toArray(infoTeclado =>{
                if(infoTeclado)
                {
                    ...
                    for(let i = 0; i < infoTeclado[id].arrayTeclado.length; i++)
                    {
                        ...
                        document.getElementById(strPos).setAttribute('style', 'background-color:#'+color+'; visibility: visible;font-family: \'Luckiest Guy\', sans-serif; font-size: 24px; letter-spacing:2px; line-height:18px;white-space:normal;color: black; -webkit-text-stroke: 1px white');
                    }
